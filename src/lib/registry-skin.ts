...
export const HOUSE_DEMO_ENGLISH =
  /Monthly Revenue|Should I learn|shine like the star you are|Pull to refresh|Unleash Full Potential|James Medrano|Alex shared a draft|Start with Pythom|Every great video starts|HyperFrames lets you/i;
